...
public class PunctaCntrImageCanvas extends ImageCanvas {
    private PunctaCounter pc;
    ...
    public PunctaCntrImageCanvas(ImagePlus img, PunctaCounter pc, int canvasID, Overlay displayList) {
        super(img);
        this.img=img;
        this.pc = pc;
