...
public class PunctaCntrImageCanvasAutodetect extends ImageCanvas {
    private PunctaCounterAutodetect pc;
    ...
    public PunctaCntrImageCanvasAutodetect(ImagePlus img, PunctaCounterAutodetect pc, int canvasID, Overlay displayList) {
        super(img);
        this.img=img;
        this.pc = pc;
