...
public class PunctaCntrImageCanvasRemoveInadequate extends ImageCanvas {
    private PunctaCounterRemoveInadequate pc;
    ...
    public PunctaCntrImageCanvasRemoveInadequate(ImagePlus img, PunctaCounterRemoveInadequate pc, int canvasID, Overlay displayList) {
        super(img);
        this.img=img;
        this.pc = pc;
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (pc.isDelmode()) {
           ...
           if (m.getRad() != 0)
			 ...
			 pc.MeasureByClick(x, y, img.getCurrentSlice());
			 pc.GroupAndRemoveRedundant();
        }
