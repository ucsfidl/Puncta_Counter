 ...
 * by Sebastian Espinosa and Vito Cairone for Dr. Michael Stryker's 
   ...
   public int lastCanvasClickedForManualLink = -1;
	...
	int ind4 = img2.getTitle().indexOf('x');
	 DayXML2S =img2.getTitle().substring(ind3+3,ind4-2);
        ...
        String filePath1 = "/nas/data/sebastian/structural/punctacounter/all_xml_v02/"+img1.getTitle()+"_3.xml";


	IJ.showStatus("Loading markers image Day"+DayXML2S);
        currentMarkerVector = (PunctaCntrMarkerVector)typeVector.get(1);
	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v02/"+img2.getTitle()+"_3.xml"; 
	...
	IJ.showStatus("Measure Day"+DayXML1S+"Day"+DayXML2S);
       ...
       String filePath3 = "/nas/data/sebastian/structural/punctacounter/compare_xml_v02/Day"+DayXML1S+"Day"+DayXML2S+"/"+img1.getTitle()+"_Day"+DayXML2S+".xml";

       exportMarkers2(filePath3,1);
       String filePath4 = "/nas/data/sebastian/structural/punctacounter/compare_xml_v02/Day"+DayXML1S+"Day"+DayXML2S+"/"+img2.getTitle()+"_Day"+DayXML1S+".xml";
            ...
            createLoadMarkersGUI2();           
	            ...
	            if (ManualXML == 0 || LoadXML1 == 0) {
	            	loadMarkers();
	             	...
	             	String filePath = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+".xml"; 
	             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+".xml"; 
	            	loadMarkers2(filePath, filePath2); //loadmarkers2 does not actually use filePath2 when not in compare mode
	            } else if (LoadXML1 > 1) {
	             	String filePath = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+"_"+LoadXML1+".xml";
	             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+"_"+LoadXML1+".xml";
	            	loadMarkers2(filePath, filePath2); //loadmarkers2 does not actually use filePath2 when not in compare mode
	            }       
            } else {
            	if (LinkedXML == 0) {
	 	            if (ManualXML == 0 || LoadXML1 == 0 || LoadXML2 == 0) {
		            	loadMarkers();
		            } else if (LoadXML1 == 1 && LoadXML2 == 1) {
		             	String filePath = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+".xml";
		             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img2.getTitle()+".xml"; 
		            	loadMarkers2(filePath, filePath2);
		            } else if (LoadXML1 > 1 && LoadXML2 > 1) {
		             	String filePath = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+"_"+LoadXML1+".xml"; 
		             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img2.getTitle()+"_"+LoadXML2+".xml";
		            	loadMarkers2(filePath, filePath2);
		            } else if (LoadXML1 == 1 && LoadXML2 > 1) {
		             	String filePath = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img1.getTitle()+".xml"; 
		             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/all_xml_v0"+GorRXML+"/"+img2.getTitle()+"_"+LoadXML2+".xml"; 
	            	...
	            	if (ManualXML == 0) {
		            	...
		            	relinkBasedOnResultNums();
		             	...
		             	String filePath = "/nas/data/sebastian/structural/punctacounter/compare_xml_v0"+GorRXML+"/"+img1.getTitle()+"_Day"+DayXML2+".xml";
		             	String filePath2 = "/nas/data/sebastian/structural/punctacounter/compare_xml_v0"+GorRXML+"/"+img2.getTitle()+"_Day"+DayXML1+".xml";
		            	loadMarkers2(filePath, filePath2);
		            	relinkBasedOnResultNums();
		            }            
	            }
...
//-----------------------------EXPORT MARKERS  
    ...
    private String getFilePath(JFrame parent, String dialogMessage, int dialogType){
        ...
        String myDirectory = "/nas/data/sebastian/structural/punctacounter";
...
//-----------------------------SHOW RESULTS TABLE
	 public void report(){
		if (results_initialized)
			rt.show("Results");
			String path = "/nas/data/sebastian/structural/punctacounter/compare_xml_v02/Day"+DayXML1S+"Day"+DayXML2S+"/"+img2.getTitle()+"_Day"+DayXML1S+".xls";
			int ind1 = img1.getTitle().indexOf('D');
			int ind5 =img1.getTitle().indexOf('v');
			String path2 = "/nas/data/sebastian/structural/punctacounter/structural-consolidated-1Oct2016/Comparison/xlsx/" +img1.getTitle().substring(0,ind1).replace("Spot","0")+img1.getTitle().substring(ind5-4,ind5-1)+"-Day"+DayXML1S+"Day"+DayXML2S+".txt";
			try {
				rt.saveAs(path2);
				rt.saveAs(path);
			} catch (IOException e) {
