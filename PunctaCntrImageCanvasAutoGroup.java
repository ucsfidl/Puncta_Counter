...
public class PunctaCntrImageCanvasAutoGroup extends ImageCanvas {
    private PunctaCounterAutoGroup pc;
    ...
    public PunctaCntrImageCanvasAutoGroup(ImagePlus img, PunctaCounterAutoGroup pc, int canvasID, Overlay displayList) {
        super(img);
        this.img=img;
        this.pc = pc;
